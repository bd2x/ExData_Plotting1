...
##2. Top Right Plot
plot(dt, inp$Voltage, type="l", xlab="datetime", ylab="Voltage" )
...
legend("topright", names(inp)[7:9],lty=1, col=c('black','red','blue'), bty="n")

##4. Bottom Right Plot
plot(dt, inp$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power" )
